...
const products = [
  ...
  },
  {
    ...
    title: "JORDAN",
    price: 149,
    desc: "The Travis Scott x Air Jordan 1 High OG is the limited edition collaboration from the rap superstar and Jordan Brand on the iconic silhouette that features a major twist.",
    colors: [
      {
        code: "lightgray",
        img: "./img/jordan.png",
  ...
  },
  {
    ...
    title: "BLAZER",
    price: 109,
    desc: "In the '70s, Nike was the new shoe on the block. So new in fact, we were still breaking into the basketball scene and testing prototypes on the feet of our local team. Of course, the design improved over the years, but the name stuck.",
    colors: [
      {
        code: "lightgray",
        img: "./img/blazer.png",
